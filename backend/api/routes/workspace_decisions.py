...
from services.decision_memory_service import sync_decision_memory_status
...
def update_decision_in_workspace(
    ...
    background_tasks.add_task(sync_decision_memory_status, decision_id, body.status, user_id)
